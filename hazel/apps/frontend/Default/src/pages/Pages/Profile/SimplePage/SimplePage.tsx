                                ...
                                <div className="p-2">
                                    ...
                                    <div className="hstack text-white-50 gap-1">
                                        <div className="me-2"><i
                                            ...
                                            United States</div>
                                        <div><i
                                            className="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>Hazel Inventory
                                        </div>
                                    </div>
                                </div>
                            </Col>
                                                            ...
                                                            <Table className="table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="text-muted">daveadame@hazel.com</td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <Link to="#" className="fw-semibold">www.hazel.com</Link>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                                                    ...
                                                                                    <UncontrolledCollapse toggler="collapseFive" defaultOpen>
                                                                                        <div
                                                                                            ...
                                                                                            <p className="text-muted mb-2">
                                                                                                ...
                                                                                                have a Hazel Inventory account. Use the
                                                                                                Hazel Inventory to share
                                                ...
                                                <div className="acitivity-timeline">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2">added a new member to Hazel Inventory
                                                                dashboard</p>
