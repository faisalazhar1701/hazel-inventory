...
const EcommerceOrders = () => {
  ...
  const {
    orders, isOrderSuccess, error, isLoading
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        enableColumnFilter: false,
        cell: (cell: any) => {
          return <Link to={`/apps-ecommerce-order-details/${cell.row.original.id}`} className="fw-medium link-primary">{cell.getValue()}</Link>;
        },
      },
      {
        header: "Channel",
        ...
        cell: (cell: any) => {
          ...
          return <span className="badge bg-info-subtle text-info">{channel}</span>;
        },
      },
      {
        header: "Customer",
            ...
            <Card id="orderList">
              ...
              <CardBody className="pt-0">
                <div>
                  ...
                  {isLoading ? (
                  ...
                  ) : isOrderSuccess && orderList.length > 0 ? (
                    <TableContainer
                      columns={columns}
                      data={(orderList || [])}
                      isGlobalFilter={true}
                    ...
                    <div className="py-4 text-center">
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted">No orders available at the moment.</p>
                      </div>
                    </div>
                  )}
                </div>
