  ...
  return (
    <React.Fragment>
      <tr>
        ...
        <td>{props.product.price ? `$${props.product.price.toFixed(2)}` : 'N/A'}</td>
        <td>{props.product.qty || props.product.quantity || 0}</td>
        <td>
        ...
        <td className="fw-medium text-end">{props.product.total ? `$${props.product.total.toFixed(2)}` : (props.product.amount || 'N/A')}</td>
      </tr>
    </React.Fragment>
  );
};
