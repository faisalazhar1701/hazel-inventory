...
const CoverSignUp = () => {
    document.title = "Cover SignUp | Hazel Inventory";
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Get your Hazel Inventory account now.</p>
                                                </div>
                                                ...
                                                <div className="mt-4">
                                                    <Form
                                                        ...
                                                        <div className="mb-4">
                                                            <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Hazel Inventory <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="text-center">
                                    <p className="mb-0">{new Date().getFullYear()} Hazel Inventory. </p>
                                </div>
                            </div>
                        </div>
                    </Container>
